...
";
            ...
            const string jsonName = "Pages_Index_razor.rsg.json";
            var json = result.GetHostOutputs()[0].Value;
...
"),
            ...
            var formattedJson = new RazorCodeDocumentSerializer(Formatting.Indented).Serialize(document);
            Extensions.VerifyTextMatchesBaseline(formattedJson, jsonName);
        }
